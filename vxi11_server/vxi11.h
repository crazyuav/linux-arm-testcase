...
struct Create_LinkParms {
	...
	bool_t lockDevice;  /* attempt to lock the device */
	u_long lock_timeout;/* time to wait on a lock */
...
*/
	Device_ErrorCode error;
	/*The value of lid SHALL be unique for all currently
	active links within a network instrument server*/
	Device_Link lid;
	u_short abortPort;/* for the abort RPC */
	u_long maxRecvSize;/* specifies max data size in bytes
                        device will accept on a write ,This value SHALL be at least 1024*/
};
...
struct Device_WriteResp {
	 ...
	 */
	Device_ErrorCode error;
	u_long size;/* Number of bytes written */
};
...
*/
	Device_ErrorCode error;
/*
Bit assignments for reason are shown in Table B.7.@VXI-11
Bit # 31 -	3	2  1   0
